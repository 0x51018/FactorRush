...
const COPY = {
  ko: {
    ...
    factorPrimeAnswerToggle: "소수 문제를 숫자 하나로 입력",
    factorPrimeAnswerHint: `기본 규칙은 "${FACTOR_PRIME_SHOUT}" 입력이며, 켜면 숫자 하나만 정답으로 인정합니다.`,
    factorOrderedLabel: "하드 모드: 소인수의 순서까지 정확히 맞춰야 정답",
    ...
    spectatorLabel: "관전자",
    spectatorTitle: "관전석",
    spectatorLiveTitle: "현재 이 라운드는 관전 중입니다.",
    spectatorLiveBody: "점수판과 정답 공개를 볼 수 있고, 로비로 돌아가면 플레이어 좌석에 참가할 수 있습니다.",
    ...
    liveBoardBody: "점수와 제출 상태를 확인하세요.",
    feedLabel: "채팅",
    feedTitle: "룸 채팅",
    feedLauncher: "채팅 /",
  ...
  en: {
    ...
    factorPrimeAnswerToggle: "Answer prime targets with the number only",
    factorPrimeAnswerHint: `By default prime prompts require "${FACTOR_PRIME_SHOUT}". Enable this to accept the number instead.`,
    factorOrderedLabel: "Hard mode: factor order must match exactly",
    ...
    spectatorLiveTitle: "You are spectating this round.",
    spectatorLiveBody: "You can follow the board and answer reveal, then take a player seat back in the lobby.",
    ...
    liveBoardBody: "Check score and submission status.",
    feedLabel: "Chat",
    feedTitle: "Room chat",
    feedLauncher: "Chat /",
